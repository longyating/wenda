...
public class JedisAdapter implements InitializingBean {
    ...
    private JedisPool pool;
        ...
        jedis.zremrangeByLex(setKey, "(c", "+"); //不包括C 以上的全删除
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        config.setMaxTotal(PropertyUtil.getIntegerProperty("redis.max.total"));
        config.setMaxIdle(PropertyUtil.getIntegerProperty("redis.max.idle"));
        config.setMinIdle(PropertyUtil.getIntegerProperty("redis.min.idle"));
        config.setBlockWhenExhausted(PropertyUtil.getBooleanProperty("redis.lock.when.exhausted"));
        pool = new JedisPool(config,
                PropertyUtil.getProperty("redis.ip"),
    ...
    public long srem(String key, String value){ //集合key 里删除成员value
        Jedis jedis = null;
        try{
            jedis = pool.getResource();
    ...
    public long scard(String key){//集合key 里有多少成员
        Jedis jedis = null;
        try{
            jedis = pool.getResource();
    ...
    public boolean sismember(String key, String value){//集合key 里是否包含成员value
        Jedis jedis = null;
        try{
            jedis = pool.getResource();
    ...
    public List<String> brpop(int timeout, String key){ //弹出
        Jedis jedis = null;
        try{
            jedis = pool.getResource();
    ...
    public long lpush(String key, String value) { //插入
        Jedis jedis = null;
        try {
            jedis = pool.getResource();
    ...
    public long zadd(String key, double score, String value){ //有序集合
        Jedis jedis = null;
        try{
            jedis = pool.getResource();
    ...
    public long zcard(String key){ //队列里面有多少元素
        Jedis jedis = null;
        try{
            jedis = pool.getResource();
    ...
    public Double zscore(String key, String member){ //队列里面有多少元素
        Jedis jedis = null;
        try{
            jedis = pool.getResource();
